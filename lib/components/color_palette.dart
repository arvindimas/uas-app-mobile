...
class ColorPalette {
  ...
  // Orange
  static const Color orange100 = Color(0xFFFFA200);
  static const Color orange80 = Color(0xFFFFB733);
  static const Color orange60 = Color(0xFFFFCC66);
  static const Color orange40 = Color(0xFFFFE099);
  static const Color orange20 = Color(0xFFFFF5CC);

  // Teal
  static const Color teal100 = Color(0xFF00B3B3);
  static const Color teal80 = Color(0xFF33C1C1);
  static const Color teal60 = Color(0xFF66CCCC);
  static const Color teal40 = Color(0xFF99D9D9);
  static const Color teal20 = Color(0xFFCCF2F2);

  // Pink
  static const Color pink100 = Color(0xFFFF66A2);
  static const Color pink80 = Color(0xFFFF80B3);
  static const Color pink60 = Color(0xFFFF99C2);
  static const Color pink40 = Color(0xFFFFB3D1);
  static const Color pink20 = Color(0xFFFFCCDF);

  // Bottom Nav icons
  static const Color navIcons = Color(0xFFC6C6C6);
}
